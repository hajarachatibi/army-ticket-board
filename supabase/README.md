...
29. Run `migrations/033_reset_available_to_pending.sql` to move all currently-available approved tickets back to pending review (one-time scam prevention sweep).
