-- Include social handles in connection preview, but only after BOTH agreed
-- and BOTH chose to share socials.
...
BEGIN
  ...
  v_show_socials :=
    (v.buyer_agreed = true AND v.seller_agreed = true)
    AND (v.buyer_social_share = true AND v.seller_social_share = true);
