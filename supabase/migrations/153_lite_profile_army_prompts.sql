-- Return ARMY profile question prompts from army_profile_questions so the lite profile UI shows the current labels (e.g. "How did you become an ARMY?" instead of hardcoded "Favorite album").
...
BEGIN
  ...
  RETURN json_build_object(
    ...
    'army_bias_prompt', COALESCE(v_army_bias_prompt, 'Bias'),
    'army_years_army_prompt', COALESCE(v_army_years_army_prompt, 'Years ARMY'),
    'army_favorite_album_prompt', COALESCE(v_army_favorite_album_prompt, 'Favorite album')
  );
END;
$$;
