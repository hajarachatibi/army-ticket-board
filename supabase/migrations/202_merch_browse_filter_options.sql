-- Extend browse_merch_listings to filter by optional filter_options keys.
...
AS $$
  ...
  ORDER BY
    ...
    m.created_at DESC;
$$;
GRANT EXECUTE ON FUNCTION public.browse_merch_listings(text, text, text, text, text, text, text) TO authenticated;
