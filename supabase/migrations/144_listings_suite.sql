-- Add Suite as a listing type (Standard / VIP / Loge / Suite).

-- 1) Add suite column to listings
ALTER TABLE public.listings
  ADD COLUMN IF NOT EXISTS suite boolean NOT NULL DEFAULT false;

-- 2) browse_listings: expose suite
...
-- 3) connection_listing_details: include suite in listing object
