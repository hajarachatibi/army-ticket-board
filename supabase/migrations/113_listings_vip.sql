-- Add VIP flag to listings (e.g. VIP / sound check packages).
-- Existing listings get vip = false; sellers can set it to true later via Edit listing.

ALTER TABLE public.listings
  ADD COLUMN IF NOT EXISTS vip boolean NOT NULL DEFAULT false;

-- Expose vip in browse_listings for display on cards.
