-- Listing removal: 3 reports for all reasons (including "Not face value").
-- Previously "Not face value" required 7; now both face-value and other reasons remove at 3 distinct reporters.
